                ...
                <div class=" grid mx-10 mb-10">
                    ...
                    <div class="mt-8 lg:mt-0 hidden md:block">
                        <div class="items-start float-left">
                            <div class="md:pr-0 float-left">
                                <img class="float-left object-cover shadow-sm lg:w-2/5 xl:h-96 lg:h-94 md:w-2/4 md:h-72 rounded-3xl lg:mr-10 md:mr-8 lg:mb-10 md:mb-8" src="{{ asset('img') }}/{{ $data->image }}" >
                                <img class="md:block hidden float-left object-cover shadow-sm lg:w-20 lg:h-4 xl:-ml-32 xl:mt-2 lg:-ml-35 lg:mt-3 md:-ml-32 md:mt-2 rounded-3xl " src="https://cdn.discordapp.com/attachments/664629434573258763/859329550759362590/wm_baru1.png" >
                                <img class="md:block hidden float-left object-cover shadow-sm lg:w-1/4 lg:h-1/4 lg:-mr-100 xl:mt-16 xl:-ml-99 lg:-ml-84 lg:mt-12 md:mt-10 md:-ml-80 rounded-3xl " src="https://cdn.discordapp.com/attachments/664629434573258763/859329547564875797/wm_baru2.png" >
                                <img class="md:block hidden float-left object-cover shadow-sm lg:w-20 lg:h-4 xl:-ml-103 xl:mt-89 lg:-ml-96 lg:mt-64 md:mt-64 md:-ml-90 rounded-3xl " src="https://cdn.discordapp.com/attachments/664629434573258763/859329550759362590/wm_baru1.png" >
                                ...
                                <h2 class="clear-none mt-6 text-left md:text-left text-xs lg:text-sm  lg:block xl:block leading-2" style="color:#706770; font-family:'Montserrat', sans-serif;">
                                    {!! $data->content !!}
                                </h2>
                            </div>
                        </div>
                    ...
                    <div class="mt-8 lg:mt-0 md:hidden block">
                        <div class="grid items-start grid-cols-1 md:grid-cols-2">
                            ...
                            <div class="mt-3 ml-0 lg:-ml-12 md:ml-8 md:mt-0">
                                ...
                                <h2 class="clear-none mt-6 text-left md:text-left text-xs lg:text-sm  lg:block xl:block leading-2" style="color:#706770; font-family:'Montserrat', sans-serif;">
                                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Vitae, vero. Ea aspernatur voluptatum, nihil officia beatae accusamus cum fuga natus accusantium quas numquam ut tempora fugit dolore corporis laboriosam molestiae! Lorem ipsum dolor, sit amet consectetur adipisicing elit. Numquam, libero cumque. Tempore repudiandae perferendis vel iste eaque culpa aliquam eum quisquam odit sed! Iste, doloribus. Aliquid nesciunt vero suscipit expedita! Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit alias rem, libero at vel distinctio adipisci quasi cupiditate aliquid doloribus dolorum ipsa error fugiat molestiae perferendis? Deleniti quas officia voluptatum? Lorem ipsum dolor, sit amet consectetur adipisicing elit. Iure ea ex quia laboriosam magni asperiores. Asperiores voluptatibus ipsam nisi, nostrum alias excepturi suscipit saepe, necessitatibus quisquam eum fuga quia expedita. Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque assumenda, asperiores consequatur voluptatum debitis aspernatur porro delectus magnam sunt voluptas voluptatem quia distinctio natus iste facere? Harum et veritatis delectus. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quis soluta quaerat dolore sapiente ullam sunt temporibus ut. Nobis praesentium odio optio sequi quos, perspiciatis eligendi dolores necessitatibus ut repudiandae eveniet. Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus, laboriosam. Quidem atque id voluptas deserunt dolores nam illo placeat. Possimus, maxime beatae! Rerum id, molestiae nam pariatur optio sint inventore. Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aliquid rerum delectus tempora atque quaerat! Id quibusdam accusantium, reprehenderit sunt, esse quam ipsam fugit, placeat alias incidunt amet nam omnis! Obcaecati!
                                </h2>
                            </div>
                        </div>
                    </div>
