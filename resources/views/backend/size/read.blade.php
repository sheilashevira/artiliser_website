...
<div class="shadow-md bg-white rounded px-10 pt-6 pb-8 mb-4 flex flex-col my-5 mx-3" >
  ...
  <div class="-mx-3 md:flex mb-6">
    <div class="md:w-full px-3">
      ...
      <textarea readonly style="border-color:#670067" class="appearance-none block w-full bg-grey-lighter text-sm text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3" id="grid-price" type="text">{{ $data->name }}</textarea>
