...
<form action="/size/insert" method="POST">
    @csrf
  <div class="-mx-3 md:flex mb-2">
    <div class="md:w-full px-3 mb-6 md:mb-0">
      ...
      <input id="name" name="name" class="appearance-none block w-full bg-grey-lighter text-sm text-grey-darker border border-red rounded py-3 px-4 mb-3" style="border-color:#670067" id="grid-first-name" type="text" placeholder="Input Size">
  ...
  <div class="-mx-3 md:flex mb-6">
    <div class="md:w-full px-3">
      ...
      <textarea id="name" name="description" class="border-2 border-gray-500"></textarea>
        <div class="text-red-600">
          @error('description')
            {{ $message}}
          @enderror
  ...
  <div class="card-footer">
    ...
    <a href="/size" style="color:#670067; border-color:#670067" class="inline-block px-6 py-1 text-xs font-medium leading-6 text-center transition bg-transparent border rounded ripple focus:outline-none">Back</a>
  </div>
</form>
</div>
