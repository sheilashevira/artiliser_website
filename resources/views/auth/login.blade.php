...
<body class="min-h-screen px-0 pt-0 pb-0 body-bg md:pt-0 md:px-0" style="font-family:'Lato',sans-serif;">
    <div class="w-full h-full">
        <div class="flex flex-col items-center justify-center flex-1 h-screen px-4 sm:px-0">
            <div class="flex w-full bg-white rounded-lg shadow-2xl sm:w-3/4 lg:w-1/2 sm:mx-0" style="height: 500px;">
                <div class="flex flex-col w-full p-4 lg:border-r-2 lg:border-artiliser md:w-1/2 md:border-r-2 md:border-artiliser">
                    <div class="flex flex-col justify-center flex-1 mb-8">
                        {{-- Login Header --}}
                        <h1 class="text-2xl font-thin text-center" style="color: #670067">Welcome Back!</h1>
                        <h2 class="text-sm font-thin text-center" style="color: #670067">Sign in to your account</h2>
