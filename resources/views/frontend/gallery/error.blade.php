...
<body>
  <div class="w-screen h-screen flex justify-center items-center">
    <div class="w-96 flex flex-col justify-center items-center">
        <img class="w-32 h-32 mb-8" src="https://freeiconshop.com/wp-content/uploads/edd/document-error-flat.png" >
        <div class="flex flex-col h-full w-full justify-center items-center">
            ...
            <p class="text-xs text-center leading-loose mx-2 " style="color:#6C656C; font-family: 'Montserrat';">
                Your transaction failed. An error occurred while placing order, please verify credit card info and try again.
            </p>
        </div>
    </div>
  </div>
