...
<form action="/size/update/{{ $data->id }}" method="POST">
    @csrf
  <div class="-mx-3 md:flex mb-2">
    <div class="md:w-full px-3 mb-6 md:mb-0">
      ...
      <input name="name" value="{{ $data->name }}" name="name" class="appearance-none block w-full bg-grey-lighter text-sm text-grey-darker border border-red rounded py-3 px-4 mb-3" style="border-color:#670067" id="grid-first-name" type="text" placeholder="Input Size">
