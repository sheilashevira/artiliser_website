...
<div class="px-2 py-3">
    <div class="flex justify-end items-center">
        ...
        <a href="/category/add" type="button" style="background-color:#670067" class="inline-block px-4 py-1 text-xs font-medium leading-6 text-center text-white transition rounded shadow ripple hover:shadow-lg focus:outline-none"><i class="fa fa-plus"></i> Add Category</a>
    </div>
</div>
<!-- Card Data Table -->
<div id='recipients' class="p-4 mt-2 lg:mt-0 rounded shadow bg-white">
    ...
    @if (session ('error'))
        <div class="py-3 px-5 mb-4 bg-red-100 text-green-900 text-sm rounded-md border border-red-200 alert alert-success alert-dismissible">
            <!-- <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> -->
                ...
                <td class="text-center">
                    <div class="flex item-center justify-center">
                        <div class="w-4 mr-2 transform hover:text-purple-900 hover:scale-110">
                            <a href="{{ route('category.read', $data->id) }}">
    ...
    <div class="w-full  max-w-lg p-5 relative mx-auto my-auto rounded-xl shadow-lg bg-white ">
      ...
      <div class="">
        ...
        <div class="text-center p-5 flex-auto justify-center">
            ...
            This category cannot be undone</p>    
        </div>
        <!--footer-->
        <div class="p-3  mt-2 text-center space-x-4 md:block">
            ...
            <a href="{{ route('category.delete', $data->id) }}" type="button" class="inline-block px-6 py-2 text-xs font-medium leading-6 text-center text-white transition bg-red-500 rounded shadow ripple hover:shadow-lg hover:bg-red-600 focus:outline-none">Delete</a>
        </div>
      </div>
    </div>
</div>
