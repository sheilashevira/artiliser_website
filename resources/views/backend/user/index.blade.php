                ...
                <td class="text-center">
                    <div class="flex item-center justify-center">
                        {{-- <div class="w-4 mr-2 transform hover:text-purple-900 hover:scale-110">
                            <a href="{{ route('user.read', $data->id) }}">
...
<!-- Card Data Table -->
@foreach ($users as $data)
<div class="modal min-w-screen h-screen animated fadeIn faster  fixed  left-0 top-0 flex justify-center items-center inset-0 z-50 outline-none focus:outline-none hidden"  style="background: rgba(0,0,0,.2);" id="delete{{ $data->id}}">
    <div class="w-full  max-w-lg p-5 relative mx-auto my-auto rounded-xl shadow-lg bg-white ">
      ...
      <div class="">
        ...
        <div class="text-center p-5 flex-auto justify-center">
            ...
            <p class="text-sm text-gray-500 px-8">Do you really want to delete this user?
            This user cannot be undone</p>    
        </div>
        <!--footer-->
        <div class="p-3  mt-2 text-center space-x-4 md:block">
            ...
            <a href="{{ route('user.delete', $data->id) }}" type="button" class="inline-block px-6 py-2 text-xs font-medium leading-6 text-center text-white transition bg-red-500 rounded shadow ripple hover:shadow-lg hover:bg-red-600 focus:outline-none">Delete</a>
        </div>
      </div>
    </div>
</div>
