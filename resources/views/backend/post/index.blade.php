...
<div class="px-2 py-3">
    <div class="flex justify-end items-center">
        ...
        <a href="/post/add" type="button" style="background-color:#670067" class="inline-block px-4 py-1 text-xs font-medium leading-6 text-center text-white transition rounded shadow ripple hover:shadow-lg focus:outline-none"><i class="fa fa-plus"></i> Add Post</a>
    </div>
</div>
<!-- Card Data Table -->
    ...
    <table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
        <thead>
            <tr>
                ...
                <th data-priority="2">Post Name</th>
                <th data-priority="3">Category</th>
                <th data-priority="4">Carousel Rows</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">{{ $data->categories->name}}</td>
                <td class="text-center">{{ $data->carousel_rows->name}}</td>
                <td class="flex justify-center">
                    <img src="{{ asset('img') }}/{{ $data->image}}" width="125px">
                </td>
                <td class="text-center">
                    <div class="flex item-center justify-center">
                        <div class="w-4 mr-2 transform hover:text-purple-900 hover:scale-110">
                            <a href="{{ route('post.read', $data->id) }}">
    ...
    <div class="w-full  max-w-lg p-5 relative mx-auto my-auto rounded-xl shadow-lg bg-white ">
      ...
      <div class="">
        ...
        <div class="p-3  mt-2 text-center space-x-4 md:block">
            ...
            <a href="{{ route('post.delete', $data->id) }}" type="button" class="inline-block px-6 py-2 text-xs font-medium leading-6 text-center text-white transition bg-red-500 rounded shadow ripple hover:shadow-lg hover:bg-red-600 focus:outline-none">Delete</a>
        </div>
      </div>
    </div>
</div>
